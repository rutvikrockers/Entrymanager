        ...
        public void onTabReselected(android.app.ActionBar.Tab tab, android.app.FragmentTransaction ft) {
            if (mListener != null) {
                ...
                if (mActivity instanceof FragmentActivity) {
                    trans = ((FragmentActivity)mActivity).getFragmentManager().beginTransaction()
        ...
        public void onTabSelected(android.app.ActionBar.Tab tab, android.app.FragmentTransaction ft) {
            if (mListener != null) {
                ...
                if (mFragmentTransaction == null && mActivity instanceof FragmentActivity) {
                    mFragmentTransaction = ((FragmentActivity)mActivity).getFragmentManager().beginTransaction()
                            .disallowAddToBackStack();
                }
